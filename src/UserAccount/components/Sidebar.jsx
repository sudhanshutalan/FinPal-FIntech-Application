            ...
            <div className="top_section">
                      ...
                      menuItems.map((item, index)=>(
                          <NavLink to={item.path} 
                            ...
                            className="side-menu" 
                              ...
                              >
                              <div className="icon-A" >{item.img}</div>
                          </NavLink>
                    ))
                ...
                {!isIcon ? 
                  <div className="side-menu">
                    <img src={Logout} onClick={logoutSubmit} className="icon-A"  alt="" />
                  </div>
                 
                  : 
                  
                <p  className="link_text" onClick={logoutSubmit} role='button'>Logout</p>
              }
                </div>
            </div>
